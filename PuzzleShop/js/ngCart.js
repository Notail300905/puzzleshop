...
angular.module('ngCart', ['ngCart.directives'])
    ...
    .service('ngCart', ['$rootScope', 'ngCartItem', 'store', function ($rootScope, ngCartItem, store) {
        ...
        this.addItem = function (id, name, price, quantity,  data, foto ){
            ...
            if (typeof inCart === 'object'){
                ...
                var newItem = new ngCartItem(id, name, price, quantity,  data, foto);
        ...
        this.$restore = function(storedCart){
            ...
            angular.forEach(storedCart.items, function (item) {
                _self.$cart.items.push(new ngCartItem(item._id, item._name, item._price, item._quantity, item._data, item._foto));
            });
            this.$save();
        };
    ...
    .factory('ngCartItem', ['$rootScope', '$log', function ($rootScope, $log) {
        ...
        var item = function (id, name, price, quantity,  data,foto) {
            this.setId(id);
            this.setName(name);
        ...
        item.prototype.setFoto = function (foto) {
            if (foto) this._foto = foto;
            else {
                $log.error('A foto must be provided');
            }
        };
        item.prototype.getFoto = function () {
            return this._foto;
        };
